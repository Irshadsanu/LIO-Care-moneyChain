...
class NewPmcScreen extends StatefulWidget {
  const NewPmcScreen({Key? key}) : super(key: key);

  @override
  State<NewPmcScreen> createState() => _NewPmcScreenState();
}

class _NewPmcScreenState extends State<NewPmcScreen>with SingleTickerProviderStateMixin {
                ...
                children: [
                  ...
                  Consumer<UserProvider>(builder: (context2, val565, child) {
                    return Container(
                      ...
                      width: width,
                      height: height-180,
                      child:  val565.masterPmcDistributionsList.isNotEmpty
                          ?ListView.builder(
                          shrinkWrap: true,
                                              ...
                                              if(index==0){
                                                ...
                                                callNext(
                                                    PMCPaymentScreen(
                                                      ...
                                                      userName:item.name ,
                                                      phoneNumber: val565.userPhone,
                                                      installment: item.installment, txnID: txnID,),
                                                    context);
                                                ...
                                                if(filteredPMCList[index-1].status=="PAID"){
                                                  ...
                                                  var snackBar = SnackBar(
                                                    content: Text("Please complete PMC ${item.installment-1} payment first."),
                                                  );
                ...
                children: [
                  ...
                  Consumer<UserProvider>(builder: (context2, val565, child) {
                    return Container(
                      ...
                      width: width,
                      height: height-180,
                      child:  val565.starPmcDistributionsList.isNotEmpty
                          ?ListView.builder(
                          shrinkWrap: true,
                          scrollDirection: Axis.vertical,
                          physics: const BouncingScrollPhysics(),
                ...
                children: [
                  ...
                  Consumer<UserProvider>(builder: (context2, val565, child) {
                    return Container(
                      ...
                      width: width,
                      height: height-180,
                      child:  val565.crownPmcDistributionsList.isNotEmpty
                          ?ListView.builder(
                          shrinkWrap: true,
                          scrollDirection: Axis.vertical,
                          physics: const BouncingScrollPhysics(),
