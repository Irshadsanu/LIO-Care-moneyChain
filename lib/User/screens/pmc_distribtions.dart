...
class PMCDistributions extends StatelessWidget {
  String from ;
   PMCDistributions({Key? key,required this.from}) : super(key: key);
        ...
        children: [
          ...
          Consumer<UserProvider>(builder: (context2, val565, child) {
            return Container(
              ...
              width: width,
              height: height-125,
              child:  val565.filterPmcDistributionsList.isNotEmpty
                  ?ListView.builder(
                      shrinkWrap: true,
