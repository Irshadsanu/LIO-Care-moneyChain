...
class PRCPaymentScreen extends StatelessWidget {
  final String amount;
  final String fromId;
                  ...
                  children: [
                    InkWell(
                      onTap: (){
                        if(!value.gatewayHider){
                          ...
                          value3.prcUpiIntent(context, payAmount, phoneNumber, "GPay", value.appBuildVersion.toString(), fromId,
                              distributionId, userName,txnID);
                    ...
                    InkWell(
                      onTap: (){
                        if(!value.gatewayHider){
                          String payAmount = amount;
                          value3.prcUpiIntent(context, payAmount, phoneNumber, "BHIM", value.appBuildVersion.toString(), fromId,
                              distributionId, userName,txnID);
                        }
                      },
                      child: Container(
